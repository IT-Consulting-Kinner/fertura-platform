...
/**
 * Module lifecycle management. Modules run in-process; trust is established at install
 * time (signature + review + the capability gate).
 *
 *   bin/cake module list
 *   bin/cake module install /path/to/module
