 ...
 * cookies: HttpOnly (not script-readable) + SameSite=Lax always, Secure fail-safe ON
 * outside local debug/dev (see CookieSecurity). The token is meaningless once the session is
